...
%setup -q -n karchive-6.5.0
cd %{_builddir}/karchive-6.5.0
pushd ..
cp -a karchive-6.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723218622
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6Archive.so.6.5.0
/usr/lib64/libKF6Archive.so.6
/usr/lib64/libKF6Archive.so.6.5.0
