...
%prep
%setup -q -n karchive-5.70.0
cd %{_builddir}/karchive-5.70.0
...
cp %{_builddir}/karchive-5.70.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/karchive/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Archive.so.5.70.0
